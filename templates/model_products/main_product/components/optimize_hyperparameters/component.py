...
@dsl.component(
    target_image=mdk.util.framework.getTargetImage(__file__, "optimize_hyperparameters")
)
def optimize_hyperparameters(
    ...
    if custom_job_executed:
        ...
        val_dataset_uri = val_dataset.uri
        ...
        hyperparameters_dict = (
            model_workflow.optimize_hyperparameters.optimize_hyperparameters(
