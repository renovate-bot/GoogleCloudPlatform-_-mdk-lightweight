...
@dsl.component(
    target_image=mdk.util.framework.getTargetImage(__file__, "sklearn_train")
)
def sklearn_train(
    ...
    if custom_job_executed:
        ...
        # Download our hyperparameters from GCS:
        ...
        # Train our model using our example sklearnoost model.
        model_filename = sklearn_example.train.train(
