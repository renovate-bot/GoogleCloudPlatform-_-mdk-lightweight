...
@dsl.component(target_image=mdk.util.framework.getTargetImage(__file__, "sklearn_optimize_hyperparameters"))  # fmt: skip
def sklearn_optimize_hyperparameters(
    ...
    os.environ["GOOGLE_CLOUD_PROJECT"] = gcp_config.get("project_id")  # for BQ
    ...
    if custom_job_executed:
        ...
        hyperparameters_dict = (
            sklearn_example.optimize_hyperparameters.optimize_hyperparameters(
